...
export default function Page() {
  ...
  return (
    <div className=" flex flex-col items-center gap-8 dark:text-gray-600">
      ...
      <div className="relative flex w-[30vw] min-w-[320px] max-w-[400px]  flex-col items-center gap-2 overflow-hidden rounded-md  border-2  dark:border-0   p-4 shadow-md">
        <form
          className="w-full"
